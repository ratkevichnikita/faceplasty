      ...
      <div className="">
        ...
        <div className="flex items-center justify-between p-[1.04vw] border-t border-t-[#00000014]">
          ...
          {href && (
            <Link
              href={href}
              className="flex items-center group justify-center gap-[0.83vw] rounded-full w-[11.67vw] h-[3.13vw] block uppercase ml-auto font-semibold text-[0.83vw] text-center border border-[#00000014]"
            >
              Jump to course
