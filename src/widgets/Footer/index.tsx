...
const Footer = () => {
  return (
   <div className="bg-black text-white pt-[2.34vw] pb-[4.01vw]">
        ...
        <div className="flex justify-between items-end">
          <div>
              <Image
                ...
                className="mb-[1.30vw]"
              />
              <p className="text-[0.94vw] font-montserrat mb-[1.04vw] leading-[1.2em]">
              ...
              <div className="space-y-[0.52vw] mb-[1.04vw]">
              ...
              <div className="flex gap-[1.04vw] mb-[1.04vw]">
                <Link
                  href="mailto:support@fp-platform.online"
                  className="flex items-center bg-green justify-center gap-[0.52vw] h-[3.13vw] text-white rounded-[2.04vw] px-[1.04vw]"
                >
                  <Image
                    src={IconEmail.src}
                    ...
                    alt="email icon"
                    className="size-[0.78vw]"
                  />
                  <span className="font-semibold text-[0.83vw] uppercase">support@fp-platform.online</span>
                </Link>
                <Link
                  href="mailto:support@fp-platform.online"
                  className="flex items-center bg-green justify-center gap-[0.52vw] h-[3.13vw] text-white rounded-[2.04vw] w-[14.58vw]"
                >
                  <Image
                    src={IconWp.src}
                    width={IconWp.width}
                  ...
                  />
                  <span className="font-semibold text-[0.83vw] uppercase">Whats app</span>
                </Link>
                <button className="h-[3.13vw] bg-orange text-white text-[0.83vw] px-[2.08vw] font-semibold rounded-[2.04vw] uppercase">
                  log in
                </button>
              </div>
              <p className="text-[0.94vw]">
